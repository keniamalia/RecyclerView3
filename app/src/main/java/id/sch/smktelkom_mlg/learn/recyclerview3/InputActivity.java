...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etDesktipsi = (EditText) findViewById(R.id.editTextDeskripsi);
    ...
    private void fillData() {
        ...
        etDesktipsi.setText(hotel.deskripsi);
    ...
    private void doSave() {
        ...
        String deskripsi = etDesktipsi.getText().toString();
